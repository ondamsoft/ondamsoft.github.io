...
var LANG = {
  ko: {
    ...
    'dev.text3': '\'온담\'이라는 이름은 \'따뜻한 이야기, 온전하게 담다\'라는 뜻이에요. 저는 개인적으로 고양이를 너무 좋아합니다. 그래서 온담 패밀리에는 네 마리의 고양이가 함께하고 있어요.',
    'dev.text4': '치즈냥 온담이, 고등어냥 온독이, 까망냥 온눈이, 삼색냥 온캡이. 언젠가 여유가 생기면 진짜 고양이도 키우고 싶네요.',

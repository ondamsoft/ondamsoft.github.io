...
var LANG = {
  ko: {
    ...
    'dev.text1': '저는 제조업 전산 분야의 개발자로 근무하고 있습니다. 모든 기업이 마찬가지이지만, 원가절감을 외치고 있죠. 실제로 소프트웨어 사용료를 감당하지 못하는 기업들이 많습니다.',
    'dev.text2': '그래서 생각했습니다 — 무료이면서 불편하지 않은 프로그램을 만들 수 있지 않을까? 퇴근 후 틈틈이 만들기 시작한 것이 온담 패밀리의 시작입니다.',
    'dev.text3': '\'온담\'이라는 이름은 \'따뜻한 이야기\'라는 뜻이에요. 저는 고양이를 너무 좋아합니다. 그래서 온담 패밀리에는 세 마리의 고양이가 함께하고 있어요.',
    'dev.text4': '치즈냥 온담이, 고등어냥 온독이, 까망냥 온눈이. 언젠가 여유가 생기면 진짜 고양이도 키우고 싶네요.',
    'dev.text5': '언제까지 이 길을 걸을 수 있을지 모르지만, 닿는 데까지 최선을 다하겠습니다.',
  ...
  en: {
    ...
    'dev.text1': 'I work as a developer in the IT department of a manufacturing company. Like every company, we\'re always talking about cutting costs. Many businesses genuinely struggle to afford software licensing fees.',
    'dev.text2': 'So I thought — what if I could build programs that are free but not inconvenient? I started building after work, bit by bit. That\'s how the Ondam Family began.',
    'dev.text3': '\'Ondam\' means \'warm stories\' in Korean. I absolutely love cats, so three cats have joined the Ondam Family.',
    'dev.text4': 'Ondami the cheese tabby, Ondoki the mackerel tabby, and Onnuni the black cat. Someday, when I can afford it, I\'d love to have a real cat too.',

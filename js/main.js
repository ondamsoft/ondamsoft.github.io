...
var LANG = {
  ko: {
    ...
    'dev.sharing_content': '만약 후원금이나 광고 수익이 실제로 발생한다면, 일부는 유기동물 보호 단체와 소외 계층을 위해 기부할 계획입니다. 따뜻한 도움이 필요한 모든 존재를 응원합니다.',
  ...
  en: {
    ...
    'dev.text3': '\'Ondam\' means \'warm stories, embracing completely\' in Korean. My mission is to craft tools that gently remove the small inconveniences users face every day.',
    'dev.text4': 'I build free software without ads, with honest marketing copy and quality built to last.',
    ...
    'dev.sharing_content': 'If donations or advertising revenue become available, I plan to donate a portion to animal protection organizations and those in need. I support everyone who needs a warm hand.',
